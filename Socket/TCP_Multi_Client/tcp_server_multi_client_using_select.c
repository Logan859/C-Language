...
/*
 * The simple way to handle multiple clients would be to spawn new thread for every new client connected to the server. This 
 * method is strongly not recommended because of various disadvantages, namely:
